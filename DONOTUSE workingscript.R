...
library(asnipe)
library(igraph)
setwd("~/Desktop/murphy r data/Combined CSV Feeder Files for Matrixes")
#I need to reformat the data to match the columns from the worked example
# Step 1: Read the CSV file into R
FeederA.1 <- read.csv("~/Desktop/murphy r data/Combined CSV Feeder Files for Matrixes/FeederA.csv")
...
FeederA.1$Feeder <- "A"
# Step 3: Reorder columns to place 'Feeder' between 'ID' and 'DateTime'
FeederA.1 <- FeederA.1 %>%
