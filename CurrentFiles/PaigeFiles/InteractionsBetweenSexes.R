...
masterBandingData <- read.csv("CurrentFiles/PaigeFiles/MasterBandingData23Jan2026.csv")
...
combinedInfo <- merge(rfidData[, c("RFID","DateTime","Feeder","GapToPrevious","ColorCombo","Sex")], prunedMBD, by.x="RFID",by.y="RFID")
