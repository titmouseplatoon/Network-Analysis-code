...
dataset<-read_csv ("CurrentFiles/FullRFID_Data_With_MBS.csv")
...
legend("topleft",
       ...
       pt.cex = 1)   # adjust legend point size


#### start highlight for large, high control PDF network
# print big! - will save to WD
pdf("bird_network (window= 15 sec) (10X10 size).pdf", width = 10, height = 10)
...
legend("topleft",
       ...
       pt.cex = 1,         # circle size in legend
